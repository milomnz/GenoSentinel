...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiRestTemplateResponse<Void>> handlePatientNotFound(PatientNotFoundException ex) {
        return new ResponseEntity<>(
                new ApiRestTemplateResponse<>("Not Found", ex.getMessage(), null),
                ex.getHttpStatus()
        );
    }
    ...
    public ResponseEntity<ApiRestTemplateResponse<Void>> handleExternalServiceException(ExternalServiceException ex) {
        ...
        return new ResponseEntity<>(
                new ApiRestTemplateResponse<>(statusText, message, null),
