...
import com.geno.springGateway.restTemplateNest.tumorType.application.domain.exceptions.TumorTypeNotFoundException;
...
public class TumorTypeService {
    ...
    public TumorTypeOutDto findById(Long id) {
        ...
        TumorTypeOutDto tumorType = response.getBody().getData();

        if (tumorType == null) {
            // Esta verificación es crucial si el microservicio NestJS devuelve 200 OK con un cuerpo vacío
            // en lugar de un 404.
