...
public class TumorTypeService {
    ...
    public List<TumorTypeOutDto> findAll() {
        ...
        ResponseEntity<ApiResponse<List<TumorTypeOutDto>>> response = restTemplate.exchange(
    ...
    public TumorTypeOutDto findById(Long id) {
        ...
        ResponseEntity<ApiResponse<TumorTypeOutDto>> response = restTemplate.exchange(
