...
public class ClinicalRecordService {
    ...
    public List<ClinicalRecordOutDto> findAll() {
        ...
        ResponseEntity<ApiResponse<List<ClinicalRecordOutDto>>> response = restTemplate.exchange(
    ...
    public ClinicalRecordOutDto findById(Long id) {
        ...
        ResponseEntity<ApiResponse<ClinicalRecordOutDto>> response = restTemplate.exchange(
