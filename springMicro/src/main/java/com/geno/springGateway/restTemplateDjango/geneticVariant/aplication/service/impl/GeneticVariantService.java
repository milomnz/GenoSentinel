...
public class GeneticVariantService implements IGeneticVariantService {
    ...
    public GeneticVariantService(@Qualifier("djangoRestTemplate") RestTemplate restTemplate) {
    ...
    public GeneticVariantOutDto create(GeneticVariantInDto dto) {
        HttpEntity<GeneticVariantInDto> request = new HttpEntity<>(dto, getCustomHeaders());
